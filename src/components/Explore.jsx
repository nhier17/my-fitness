...
useCardAnime();
  return (
    ...
    <div id="workout" className="flex overflow-x-auto overflow-y-hidden md:gap-4 gap-1 services"
    style={{'scrollbarWidth': 'none','::WebkitScrollbar': { 'display': 'none' }}}
    >
      {services.map((service, index) => (
        <div key={index} className="bg-gray-800 flex-1 text-center mb-10 mr-5 rounded-md overflow-hidden min-w-[300px] transition duration-300 hover:scale-105">
